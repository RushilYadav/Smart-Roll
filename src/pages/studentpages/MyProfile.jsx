        ...
        <div className="bg-white shadow-md rounded-lg p-8 flex flex-col md:flex-row gap-8">
          <div className="flex-shrink-0 flex justify-center md:justify-start">
            {student.profile_pic_url ? (
              <img src={student.profile_pic_url} alt="Profile" className="w-40 h-40 rounded-full object-cover shadow"/>
            ) : (
              <div className="w-40 h-40 rounded-full bg-gray-300 flex items-center justify-center text-gray-600">No Image</div>
            )}
          </div>
